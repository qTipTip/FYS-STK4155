...
\newcommand{\githublogo}{\raisebox{-1pt}{\includegraphics[height=9pt]{images/github}}}
...
\begin{figure}
  ...
  \begin{figure}[htpb]
  	\centering
	\subbottom[Ridge regression]{%
		\includegraphics[width=0.45\linewidth]{images/bias_variance_ridge.pdf}
	}
	\subbottom[Lasso regression]{%
		\includegraphics[width=0.45\linewidth]{images/bias_variance_lasso.pdf}
	}
  ...
  \begin{figure}[htpb]
  	\centering
	\subbottom[Ridge regression]{%
		\includegraphics[width=0.45\linewidth]{images/variance_ridge.pdf}
	}
	\subbottom[Lasso regression]{%
		\includegraphics[width=0.45\linewidth]{images/variance_lasso.pdf}
	}
...
error in the implementation, or the authors lack of experience in the field.}
  ...
  \begin{figure}[htpb]
  	\centering
	\subbottom{
		\includegraphics[width=0.45\linewidth]{images/terrain_data_mse.pdf}	
	}
	\subbottom{
		\includegraphics[width=0.45\linewidth]{images/terrain_data_r2.pdf}	
	}
